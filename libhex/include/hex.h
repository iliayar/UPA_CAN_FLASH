...
public:
    Data(std::vector<uint8_t> data, uint16_t address) noexcept
...
public:
    explicit ExtendSegmentAddress(uint16_t address) noexcept
        : m_address(address) {}
...
public:
    explicit StartSegmentAddress(uint32_t address) noexcept
        : m_address(address) {}
    Type get_type() override { return Type::ExtendSegmentAddress; }
...
public:
    explicit ExtendLinearAddress(uint16_t address) noexcept
        : m_address(address) {}
...
public:
    explicit StartLinearAddress(uint32_t address) noexcept
        : m_address(address) {}
