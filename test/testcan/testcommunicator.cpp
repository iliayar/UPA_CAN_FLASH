...
//                   3);
//         EXPECT_EQ(
//             std::static_pointer_cast<Can::Frame::FirstFrame>(frames[0])
//                 ->get_data(),
...
//                     ServiceRequest::ServiceRequest::ReadDataByIdentifier>(
//                     DataIdentifier::VIN);
//             default:
//                 m_step--;
//                 return nullptr;
...
//     std::shared_ptr<Can::Frame::Frame> frame = communicator.fetch_frame();
//     EXPECT_EQ(frame->get_type(), Can::Frame::Type::SingleFrame);
//     EXPECT_EQ(std::static_pointer_cast<Can::Frame::FirstFrame::Frame>(frame)
//                   ->get_len(),
//               3);
//     EXPECT_EQ(std::static_pointer_cast<Can::Frame::FirstFrame::Frame>(frame)
//                   ->get_data(),
...
//     std::vector<std::shared_ptr<Can::Frame::Frame>> frames;
//     frames.push_back(std::make_shared<Can::Frame::FirstFrame::Frame>(
//         20, std::vector<uint8_t>({0x62, 0xf1, 0x90, 0x41, 0x20, 0x41})));
//     frames.push_back(std::make_shared<Can::Frame::ConsecutiveFrame::Frame>(
//         1, std::vector<uint8_t>({0x20, 0x41, 0x20, 0x41, 0x20, 0x41, 0x20})));
//     frames.push_back(std::make_shared<Can::Frame::ConsecutiveFrame::Frame>(
//         2, std::vector<uint8_t>({0x41, 0x20, 0x41, 0x20, 0x41, 0x20, 0x41})));
...
//     communicator.push_frame(std::make_shared<Can::Frame::SingleFrame::Frame>(
//         4, std::vector<uint8_t>({0x62, 0x20, 0x0E, 0x03, 0x55, 0x55, 0x55})));
...
//     EXPECT_EQ(frame->get_type(), Can::Frame::Type::SingleFrame);
//     EXPECT_EQ(
//         std::static_pointer_cast<Can::Frame::FirstFrame>(frame)->get_len(), 3);
//     EXPECT_EQ(
//         std::static_pointer_cast<Can::Frame::FirstFrame>(frame)->get_data(),
//         std::vector<uint8_t>({0x22, 0xf1, 0x90, 0x00, 0x00, 0x00, 0x00}));
...
//     frames.push_back(std::make_shared<Can::Frame::FirstFrame::Frame>(
//         20, std::vector<uint8_t>({0x62, 0xf1, 0x90, 0x41, 0x20, 0x41})));
//     frames.push_back(std::make_shared<Can::Frame::ConsecutiveFrame>(
//         1, std::vector<uint8_t>({0x20, 0x41, 0x20, 0x41, 0x20, 0x41, 0x20})));
//     frames.push_back(std::make_shared<Can::Frame::ConsecutiveFrame>(
//         2, std::vector<uint8_t>({0x41, 0x20, 0x41, 0x20, 0x41, 0x20, 0x41})));
