...
public:
    ServiceRequest_ReadDataByIdentifier(DataIdentifier id) : m_id(id) {}

    ServiceRequestType get_type() {
	return ServiceRequestType::ReadDataByIdentifier;
    }
...
public:
    ServiceRequest_WriteDataByIdentifier(Data* data) : m_data(data) {}

    ServiceRequestType get_type() {
	return ServiceRequestType::WriteDataByIdentifier;
    }
    std::vector<uint8_t> dump();
...
public:
    ServiceResponse_ReadDataByIdentifier(Data* data) : m_data(data) {}

    ServiceResponseType get_type() {
	return ServiceResponseType::ReadDataByIdentifier;
    }
...
public:
    ServiceResponse_WriteDataByIdentifier(DataIdentifier id) : m_id(id) {}

    ServiceResponseType get_type() {
	return ServiceResponseType::WriteDataByIdentifier;
    }
