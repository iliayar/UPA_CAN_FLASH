...
Can::Data* Can::DataFactory::get() {
    Can::DataIdentifier type =
	static_cast<Can::DataIdentifier>(m_reader.read_16(m_offset, 16));
    m_offset += 16;
...
std::vector<uint8_t> Can::ServiceRequest_ReadDataByIdentifier::dump() {
    ...
    writer.write_8(
	static_cast<uint8_t>(Can::ServiceRequestType::ReadDataByIdentifier),
	offset, 8);
    offset += 8;
...
std::vector<uint8_t> Can::ServiceRequest_WriteDataByIdentifier::dump() {
    ...
    writer.write_8(
	static_cast<uint8_t>(Can::ServiceRequestType::WriteDataByIdentifier),
	offset, 8);
    offset += 8;
...
Can::ServiceResponse*
Can::ServiceResponseFactory::parse_ReadDataByIdentifier() {
    m_reader.add_offset(m_offset);
...
Can::ServiceResponse*
Can::ServiceResponseFactory::parse_WriteDataByIdentifier() {
