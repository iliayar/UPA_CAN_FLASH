...
void QCommunicator::request(Can::ServiceRequest* r) {
    ...
    QTransmitter* worker = new QTransmitter(r);
...
QTransmitter::QTransmitter(Can::ServiceRequest* request) {
...
QReceiver::QReceiver(std::shared_ptr<Can::Frame> frame) {
